...
class GraphicOverlay(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private var widthScaleFactor = context.resources.getDimensionPixelOffset(R.dimen.width_scale_factor).toFloat()
    private var previewHeight: Int = 0
    private var heightScaleFactor = context.resources.getDimensionPixelOffset(R.dimen.width_scale_factor).toFloat()
